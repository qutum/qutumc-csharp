...
namespace qutum.test.syntax
{
	...
	public class TestParser : IDisposable
	{
		...
		public void Blocks()
		{
			...
			a
			b");
			t = t/**/	.H(Syn.Block).H(Syn.e1).V(Lex.NAME, "a").N0();
			t = t/**/	.N(Syn.Block).H(Syn.e1).V(Lex.NAME, "b").N0().N0().N0();
			t = Parse(@"
					a
				b
				c
			d");
			t = t/**/	.H(Syn.Block).H(Syn.e1).V(Lex.NAME, "a").N0();
			t = t/**/	.N(Syn.Block).H(Syn.e1).V(Lex.NAME, "b").N0();
			t = t/**/	.N(Syn.Block).H(Syn.e1).V(Lex.NAME, "c").N0();
			t = t/**/	.N(Syn.Block).H(Syn.e1).V(Lex.NAME, "d").N0().N0().N0();
		}
		...
		public void Binary()
		{
			...
			t = t/**/					.H(Syn.e45, v: Lex.ADD);
			t = t/**/						.H(Syn.e1).V(Lex.INT, 2);
			t = t/**/						.N(Syn.e1).V(Lex.INT, 3).N0().N0().N0().N0().N0();
		}
		...
		public void HeadRight()
		{
			...
			t = t/**/							.H(Syn.e1).V(Lex.INT, 1).N0().N0();
			t = t/**/				.N(Syn.stat, v: Lex.MUL);
			t = t/**/					.H(Syn.e1).V(Lex.INT, 2).N0().N0().N0().N0();
			t = Parse(@"
			a
		...
		public void Nested2()
		{
			...
			t = t/**/					.H(Syn.e1).V(Lex.NAME, "b");
			t = t/**/					.N(Syn.stat, v: Lex.MUL);
			t = t/**/						.H(Syn.e1).V(Lex.NAME, "c").N0();
			t = t/**/					.N(Syn.stat, v: Lex.DIV);
			t = t/**/						.H(Syn.e1).V(Lex.NAME, "d");
			t = t/**/						.N(Syn.stat, v: Lex.ADD);
			t = t/**/							.H(Syn.e1).V(Lex.NAME, "e").N0().N0().N0().N0();
			t = t/**/	.N(Syn.Block).H(Syn.e1).V(Lex.NAME, "b");
			t = t/**/				.N(Syn.stat, v: Lex.SUB);
		...
		public void RecoverRight2()
		{
			...
			t = t/**/	.N(Syn.Block).H(Syn.e1).V(Lex.NAME, "c").N0();
			t = t/**/	.N(Syn.Block).H(Syn.e1).V(Lex.NAME, "d").N0().N0();
		...
		public void RecoverRight3()
		{
			...
			t = t/**/	.N(Syn.Block).H(Syn.e1).V(Lex.NAME, "c").N0().N0();
		...
		public void RecoverBlock()
		{
			...
			t = t/**/					.N(Syn.nest, -4).N0();
			t = t/**/				.N(Syn.stat, v: Lex.SUB);
			t = t/**/					.H(Syn.e1).V(Lex.NAME, "d").N0().N0();
			t = t/**/	.N(Syn.Block).H(Syn.e1).V(Lex.NAME, "e").N0().N0();
		...
		public void RecoverLine()
		{
			...
			a */
						+1
				*2");
			t = t/**/	.H(Syn.Block).H(Syn.e1).V(Lex.NAME, "a").N(Syn.line, -4);
			t = t/**/				.N(Syn.headr).H(Syn.stat, v: Lex.ADD);
			t = t/**/							.H(Syn.e1).V(Lex.INT, 1).N0().N0();
			t = t/**/				.N(Syn.stat, v: Lex.MUL);
			t = t/**/					.H(Syn.e1).V(Lex.INT, 2).N0().N0().N0();
			t = t/**/.N(Syn.all, -1, 2.7, 2.7, Lex.DIV);
			t = t/**/	.H(Syn.e43, 2).N0().N0();
		}
